var WDOSBOX = (() => {
    ...
    return (
        function (WDOSBOX) {
            ...
            function emsc_progress(file, extracted, count) {
            ...
            function ws_init_runtime(sessionId) {
                ...
                function messageHandler(e) {
                    var data = e.data;
                    if (data.name === undefined || data.name.length < 3 || data.name[0] !== "w" || data.name[1] !== "c" || data.name[2] !== "-") {
                        return
                    }
                ...
                if (worker) {
                    ...
                    Module.sharedMemory = Module.HEAPU8.buffer;
                    Module.directSound = {ringSize: soundRingSize, bufferSize: soundBufferSize, buffer: [], active: 0};
                    for (var i = 0; i < Module.directSound.ringSize; ++i) {
            ...
            function emsc_end_frame_update() {
                if (Module.frame_update_lines.length > 0) {
                    Module.sendMessage("ws-update-lines", {lines: Module.frame_update_lines}, Module.frame_update_lines_transferable)
                }
            ...
            function emsc_extract_bundle_to_fs() {
                ...
                Module.libzip_progress = function (file, extracted, count) {
                    Module.sendMessage("ws-extract-progress", {
                        index: index,
                        file: file,
                        extracted: extracted,
                        count: count
            ...
            function emsc_dump_memory_contents(memBase, ip, flags, regs, segs_val, segs_phys, numPages, copyDosMemory) {
                registerNames = ["al", "ah", "ax", "eax", "bl", "bh", "bx", "ebx", "cl", "ch", "cx", "ecx", "dl", "dh", "dx", "edx", "si", "esi", "di", "edi", "sp", "esp", "bp", "ebp", "ip", "eip"];
                registers = Object.fromEntries(registerNames.map((_, i) => [_, Module.HEAPU32[(regs >> 2) + i]]));
            ...
            var Asyncify = {
                ...
                instrumentWasmImports: function (imports) {
                    var ASYNCIFY_IMPORTS = ["env.syncSleep", "env.invoke_*", "env.emscripten_sleep", "env.emscripten_wget", "env.emscripten_wget_data", "env.emscripten_idb_load", "env.emscripten_idb_store", "env.emscripten_idb_delete", "env.emscripten_idb_exists", "env.emscripten_idb_load_blob", "env.emscripten_idb_store_blob", "env.SDL_Delay", "env.emscripten_scan_registers", "env.emscripten_lazy_load_code", "env.emscripten_fiber_swap", "wasi_snapshot_preview1.fd_sync", "env.__wasi_fd_sync", "env._emval_await", "env._dlopen_js", "env.__asyncjs__*"].map(x => x.split(".")[1]);
            ...
            var asmLibraryArg = {
                ...
                "W": __tzset_js,
                "a": _abort,
                "V": destroyMessageSyncSleep,
                "U": destroyTimeoutSyncSleep,
                "T": emsc_add_frame_line,
                "S": emsc_dump_memory_contents,
                "R": emsc_end_frame_update,
                "m": emsc_exit_runtime,
                "Q": emsc_extract_bundle_to_fs,
                "l": emsc_getMTimeMs,
                "P": emsc_pack_fs_to_bundle,
                "O": emsc_progress,
                "N": emsc_start_frame_update,
                "M": emsc_ws_client_frame_set_size,
                "L": emsc_ws_client_sound_init,
                "K": emsc_ws_client_sound_push,
                "J": emsc_ws_exit_runtime,
                "c": _emscripten_asm_const_int,
                "k": _emscripten_date_now,
                "I": _emscripten_exit_with_live_runtime,
                "H": _emscripten_force_exit,
                ...
                "g": _fd_write,
                "F": _gethostbyname,
                "E": initMessageSyncSleep,
                "D": initTimeoutSyncSleep,
                "j": isNode,
                "C": isNormalState,
                "i": isWorker,
                "h": now,
                ...
                "x": ws_client_error,
                "w": ws_client_log,
                "v": ws_client_network_connected,
                "e": ws_client_network_disconnected,
                "u": ws_client_stdout,
                "t": ws_client_warn,
                "s": ws_init_runtime
            };
            ...
            var ___wasm_call_ctors = Module["___wasm_call_ctors"] = function () {
                return (___wasm_call_ctors = Module["___wasm_call_ctors"] = Module["asm"]["ta"]).apply(null, arguments)
            };
            var _free = Module["_free"] = function () {
                return (_free = Module["_free"] = Module["asm"]["ua"]).apply(null, arguments)
            };
            var _malloc = Module["_malloc"] = function () {
                return (_malloc = Module["_malloc"] = Module["asm"]["va"]).apply(null, arguments)
            };
            ...
            var _get_changes_mtime_ms = Module["_get_changes_mtime_ms"] = function () {
                return (_get_changes_mtime_ms = Module["_get_changes_mtime_ms"] = Module["asm"]["xa"]).apply(null, arguments)
            };
            var _zip_from_fs = Module["_zip_from_fs"] = function () {
                return (_zip_from_fs = Module["_zip_from_fs"] = Module["asm"]["ya"]).apply(null, arguments)
            };
            var _zip_to_fs = Module["_zip_to_fs"] = function () {
                return (_zip_to_fs = Module["_zip_to_fs"] = Module["asm"]["za"]).apply(null, arguments)
            };
            var _zipfile_to_fs = Module["_zipfile_to_fs"] = function () {
                return (_zipfile_to_fs = Module["_zipfile_to_fs"] = Module["asm"]["Aa"]).apply(null, arguments)
            };
            var _libzip_destroy = Module["_libzip_destroy"] = function () {
                return (_libzip_destroy = Module["_libzip_destroy"] = Module["asm"]["Ba"]).apply(null, arguments)
            };
            var _networkConnect = Module["_networkConnect"] = function () {
                return (_networkConnect = Module["_networkConnect"] = Module["asm"]["Ca"]).apply(null, arguments)
            };
            var _networkDisconnect = Module["_networkDisconnect"] = function () {
                return (_networkDisconnect = Module["_networkDisconnect"] = Module["asm"]["Da"]).apply(null, arguments)
            };
            var _extractBundleToFs = Module["_extractBundleToFs"] = function () {
                return (_extractBundleToFs = Module["_extractBundleToFs"] = Module["asm"]["Ea"]).apply(null, arguments)
            };
            var _packFsToBundle = Module["_packFsToBundle"] = function () {
                return (_packFsToBundle = Module["_packFsToBundle"] = Module["asm"]["Fa"]).apply(null, arguments)
            };
            var _addKey = Module["_addKey"] = function () {
                return (_addKey = Module["_addKey"] = Module["asm"]["Ga"]).apply(null, arguments)
            };
            var _mouseMove = Module["_mouseMove"] = function () {
                return (_mouseMove = Module["_mouseMove"] = Module["asm"]["Ha"]).apply(null, arguments)
            };
            var _mouseButton = Module["_mouseButton"] = function () {
                return (_mouseButton = Module["_mouseButton"] = Module["asm"]["Ia"]).apply(null, arguments)
            };
            var _mouseSync = Module["_mouseSync"] = function () {
                return (_mouseSync = Module["_mouseSync"] = Module["asm"]["Ja"]).apply(null, arguments)
            };
            var _exitRuntime = Module["_exitRuntime"] = function () {
                return (_exitRuntime = Module["_exitRuntime"] = Module["asm"]["Ka"]).apply(null, arguments)
            };
            var _runRuntime = Module["_runRuntime"] = function () {
                return (_runRuntime = Module["_runRuntime"] = Module["asm"]["La"]).apply(null, arguments)
            };
            var _requestPause = Module["_requestPause"] = function () {
                return (_requestPause = Module["_requestPause"] = Module["asm"]["Ma"]).apply(null, arguments)
            };
            var _requestResume = Module["_requestResume"] = function () {
                return (_requestResume = Module["_requestResume"] = Module["asm"]["Na"]).apply(null, arguments)
            };
            var _requestMute = Module["_requestMute"] = function () {
                return (_requestMute = Module["_requestMute"] = Module["asm"]["Oa"]).apply(null, arguments)
            };
            var _requestUnmute = Module["_requestUnmute"] = function () {
                return (_requestUnmute = Module["_requestUnmute"] = Module["asm"]["Pa"]).apply(null, arguments)
            };
            var _requestExit = Module["_requestExit"] = function () {
                return (_requestExit = Module["_requestExit"] = Module["asm"]["Qa"]).apply(null, arguments)
            };
            var _getConfigContent = Module["_getConfigContent"] = function () {
                return (_getConfigContent = Module["_getConfigContent"] = Module["asm"]["Ra"]).apply(null, arguments)
            };
            var _main = Module["_main"] = function () {
                return (_main = Module["_main"] = Module["asm"]["Sa"]).apply(null, arguments)
            };
            var _dumpMemory = Module["_dumpMemory"] = function () {
                return (_dumpMemory = Module["_dumpMemory"] = Module["asm"]["Ta"]).apply(null, arguments)
            };
            var _rescanFilesystem = Module["_rescanFilesystem"] = function () {
                return (_rescanFilesystem = Module["_rescanFilesystem"] = Module["asm"]["Ua"]).apply(null, arguments)
            };
            var _pauseExecution = Module["_pauseExecution"] = function () {
                return (_pauseExecution = Module["_pauseExecution"] = Module["asm"]["Va"]).apply(null, arguments)
            };
            var ___funcs_on_exit = Module["___funcs_on_exit"] = function () {
                return (___funcs_on_exit = Module["___funcs_on_exit"] = Module["asm"]["Wa"]).apply(null, arguments)
            };
            ...
            var _asyncify_start_unwind = Module["_asyncify_start_unwind"] = function () {
                return (_asyncify_start_unwind = Module["_asyncify_start_unwind"] = Module["asm"]["ab"]).apply(null, arguments)
            };
            var _asyncify_stop_unwind = Module["_asyncify_stop_unwind"] = function () {
                return (_asyncify_stop_unwind = Module["_asyncify_stop_unwind"] = Module["asm"]["bb"]).apply(null, arguments)
            };
            var _asyncify_start_rewind = Module["_asyncify_start_rewind"] = function () {
                return (_asyncify_start_rewind = Module["_asyncify_start_rewind"] = Module["asm"]["cb"]).apply(null, arguments)
            };
            var _asyncify_stop_rewind = Module["_asyncify_stop_rewind"] = function () {
                return (_asyncify_stop_rewind = Module["_asyncify_stop_rewind"] = Module["asm"]["db"]).apply(null, arguments)
            };
            var ___start_em_js = Module["___start_em_js"] = 262848;
            var ___stop_em_js = Module["___stop_em_js"] = 275012;
